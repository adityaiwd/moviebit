...
const MovieDetailPage = () => {
  ...
  if (!data) {
    return (
      <div className="p-6 space-y-3">
        <div className="text-sm text-muted-foreground">Movie not found.</div>
        <button
  ...
  return (
    <div className="p-6 space-y-6">
      <NavLink className="text-sm text-muted-foreground hover:underline" to="/">
        ← Back to list
      </NavLink>
      ...
      <div className="grid gap-6 md:grid-cols-[280px_1fr]">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-foreground/90">{data.plot}</p>
